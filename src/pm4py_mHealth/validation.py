...
def apply(data_file: str, schema_file: Optional[str] = None) -> Tuple[bool, List[str]]:
    """
    Validate if the data follows the OCEL-mHealth schema.
    
    Args:
        data_file (str): Path to the JSON file containing the OCEL-mHealth data
    ...
    if schema_file is None:
        schema_file = str(Path(__file__).parent.parent / "schema" / "OCEL-mHealth.json")
